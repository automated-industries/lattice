...
| `redacted` (Go) | Go module          | `automated-industries/redacted`      | pkg.go.dev/github.com/automated-industries/redacted |
...
Go:      github.com/automated-industries/redacted v0.15.0
...
3. **Port to Go.** Go implementation in `redacted/`. Must include:
...
- Go repo: `github.com/automated-industries/redacted` (to be created)
