...
async function enrichWithLlm(
  ...
  try {
    ...
    // Rule 16: never swallow. A client-init failure means NO auto-link for this
  ...
  try {
    ...
    for (const m of matches) {
      ...
      if (!jx && createJunction && aggressiveness >= 0.25) {
        ...
        try {
          ...
          // Rule 16: surface — a junction-create failure (e.g. cloud permission)
      ...
      if (jx) {
        ...
        try {
          ...
          // Rule 16: surface — a link failure (e.g. cloud RLS/permission) would
    ...
    // Rule 16: surface — classification failing means zero auto-links; make the
