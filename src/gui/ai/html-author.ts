...
const HTML_SYSTEM = [
  ...
  "- When the spec names source documents (files), render citation badges with `onclick=\"window.lattice.act('open-record','files:<id>')\"`, `cursor:pointer`, and a `title` tooltip. The user clicks → the GUI opens the source document.",
