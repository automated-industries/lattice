...
export const searchCss = `    /* The top search BOX was removed — the assistant ("Ask Lattice") is the single
       search surface, so its box + results styles are gone. .last-edited stays. */
