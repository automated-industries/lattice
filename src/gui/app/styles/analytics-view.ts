...
export const analyticsViewCss = `    /* ── Single workspace layout ────────────────────────── */
    ...
    .dash-frame-wrap { flex: 1 1 auto; min-height: 0; display: flex; flex-wrap: wrap; gap: 8px; }
    /* Chart-click provenance target: a full-width row BELOW the canvas (the record
       panel is the side-by-side one; this one must never sit beside the iframe). */
    .dash-frame-wrap > .dash-source { flex: 1 0 100%; }
