...
import { DEFAULT_BODY_MAX_BYTES } from '../ops/paging.js';
 ...
 *
 * This is an HTTP ADAPTER, not a capability: everything here needs a live
 * request/response pair. The limits it enforces are plain numbers with no
 * transport in them, so they live in `../ops/paging.js` where a headless caller
 * can reach them without importing a server. Nothing outside an adapter should
 * import this module.
 */
